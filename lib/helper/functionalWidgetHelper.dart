...
class FunctionalWidget {
            ...
            child: FunctionalWidget.wrapContent(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    "${FunctionalWidget.convertDateToDMY(data["from"])} s/d ${FunctionalWidget.convertDateToDMY(data["to"])}",
  ...
  static loadingDialog(BuildContext context,
      {Color color = Colors.black, title = 'tunggu sebentar'}) {
    return dialog(
        context: context,
        child: AlertDialog(
          elevation: 0.0,
          ...
          content: Column(
            ...
            children: [
              SpinKitFadingGrid(
                  color: ColorConfig.blackPrimaryColor, shape: BoxShape.circle),
            ],
          ),
        ));
  }
            ...
            TextButton(
                ...
                child: Text(label2,
                    style: Theme.of(context)
                        .textTheme
                        .subtitle1
                        .copyWith(color: ColorConfig.yellowColor))),
          ],
        ));
  }
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return ConstrainedBox(
              constraints: BoxConstraints(maxHeight: 100.0), child: child);
        });
  }
              ...
              children: <Widget>[
                Container(
                    ...
                    child: icon != null
                        ...
                        : Image.asset(
                            GeneralString.imgLocalPng + "$image.png",
  ...
  static rating({BuildContext context, double rate}) {
    ...
    return Row(
      children: [
        ...
        SizedBox(width: scale.getWidth(1)),
        Text(rate.toStringAsFixed(2).toString(),
            style: Theme.of(context).textTheme.subtitle1)
      ],
    );
  }
      ...
      children: [
        ...
        Text(":",
            style: Theme.of(context)
                .textTheme
                .subtitle1
                .copyWith(color: Theme.of(context).textTheme.subtitle2.color)),
        SizedBox(width: scale.getWidth(1)),
        child == null
            ? Text(desc, style: Theme.of(context).textTheme.headline2)
            : child,
