      ...
      if (isFilter)
        categoryProductModel.result.insert(
            ...
            Result(
                ...
                title: "semua",
                idType: 0,
                icon: "https://admin.adscoin.id/static/media/logo.828d2c16.png",
                createdAt: null,
                updatedAt: null));
    } else {
