...
class _CheckoutComponentState extends State<CheckoutComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar:
            FunctionalWidget.appBarHelper(context: context, title: "Checkout"),
        body: ListView(
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              product.detailProductModel.result.title,
                          ...
                          FunctionalWidget.spaceText(
                              ...
                              child: FunctionalWidget.rating(
                                  context: context,
                                  rate: double.parse(product
                                      .detailProductModel.result.rating
                                      .toString()))),
                          FunctionalWidget.spaceText(
                              context: context,
                              title: "Penulis",
              ...
              child: Column(
                ...
                children: [
                  ...
                  FunctionalWidget.betweenText(
                      context: context,
                      title: "Harga produk",
                      desc: FunctionalWidget.toCoin(double.parse(
                          product.detailProductModel.result.price))),
                  FunctionalWidget.betweenText(
                      context: context,
                      title: "Biaya admin",
                      desc: FunctionalWidget.toCoin(double.parse("0"))),
        ...
        bottomNavigationBar: FunctionalWidget.bottomBar(
            ...
            desc: FunctionalWidget.toCoin(
                double.parse(user.detailMemberModel.result.saldo)),
            btnText: "Bayar",
            callback: () {
              Navigator.of(context).pushNamed(RouteString.pin,
                  arguments: (code) async {
                product.storeCheckoutProduct(context: context, pin: code);
              });
            }));
  }
}
