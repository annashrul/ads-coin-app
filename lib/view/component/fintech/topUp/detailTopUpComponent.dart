...
class _DetailTopUpComponentState extends State<DetailTopUpComponent>
    ...
    return WillPopScope(
        child: Scaffold(
            ...
            body: ListView(
              ...
              children: [
                Image.asset(
                  GeneralString.imgLocalPng + "paymentInfo.png",
                ...
                Container(
                  ...
                  children: [
                    ...
                    InTouchWidget(
                        callback: () {
                          FunctionalWidget.copy(
                              context: context,
                              text: MoneyFormat.toCurrency(
                                  double.parse(val.totalPay)));
                        },
                        child: Row(
                  ...
                  child: FunctionalWidget.wrapContent(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InTouchWidget(
                            callback: () => FunctionalWidget.copy(
                                context: context, text: val.payCode),
                            child: Row(
                              children: [
                                Text(val.payCode,
                                    style:
                        ...
                        if (val.paymentType == 1)
                          Text("Nama bank",
                              style: Theme.of(context).textTheme.subtitle1),
                        if (val.paymentType == 1)
                          Text(val.paymentName,
                              style: Theme.of(context).textTheme.headline2),
                        Divider(),
                        Text("Jumlah coin",
                            style: Theme.of(context).textTheme.subtitle1),
                        Text(
                            MoneyFormat.toCurrency(double.parse(val.amount)) +
                                " coin",
                            style: Theme.of(context)
                                .textTheme
                                .headline2
                      ...
                      return GFAccordion(
                          ...
                          titleChild: Text(
                            ...
                            style: Theme.of(context)
                                ...
                                .copyWith(
                                    color:
                                        isTrue ? Colors.white : Colors.black),
                          ),
                ...
                Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          Text(
                            "Lakukan pembayaran sebelum tanggal ${FunctionalWidget.convertDateToDMY(val.expiredDate)}",
                            style: Theme.of(context).textTheme.subtitle1,
                            textAlign: TextAlign.center,
                          ),
                          if (val.paymentType == 1)
            ...
            bottomNavigationBar: Container(
              ...
              child: BackroundButtonWidget(
                ...
                title:
                    val.paymentType == 0 ? "Selesai" : "Upload bukti transfer",
                callback: () {
                  if (val.paymentType == 0) {
                    ...
                    FunctionalWidget.modal(
                        ...
                        child: UploadWidget(
                          callback: (res) {
                            print(res);
                            fintech.uploadBuktiTransfer(
                                context: context, data: res["base64"]);
                          },
  ...
  build(BuildContext context) {
    ...
    return Text("$timerText",
        style: Theme.of(context)
            .textTheme
            .headline1
            .copyWith(color: ColorConfig.yellowColor, fontSize: 24));
  }
}
