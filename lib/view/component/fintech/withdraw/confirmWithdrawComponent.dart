...
class ConfirmWithdrawComponent extends StatefulWidget {
  @override
  _ConfirmWithdrawComponentState createState() => _ConfirmWithdrawComponentState();
}
...
class _ConfirmWithdrawComponentState extends State<ConfirmWithdrawComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FunctionalWidget.appBarHelper(context: context,title: "Konfirmasi penarikan"),
      body: ListView(
        padding: scale.getPadding(1,2.5),
        children: [
          Text("Total pengurangan",style: Theme.of(context).textTheme.headline2.copyWith(color: ColorConfig.grayPrimaryColor)),
          Text(MoneyFormat.toCurrency(double.parse("10000")),style: Theme.of(context).textTheme.headline1.copyWith(color: ColorConfig.bluePrimaryColor)),
          SizedBox(height: scale.getHeight(1)),
          Text("Tarik tunai",style: Theme.of(context).textTheme.headline2.copyWith(color: ColorConfig.grayPrimaryColor)),
          ...
          FunctionalWidget.wrapContent(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Ringkasan penarikan",style: Theme.of(context).textTheme.headline2),
                    SizedBox(height: scale.getHeight(1)),
                    ...
                    SizedBox(
                      ...
                      child: DashedRect(color:ColorConfig.graySecondaryColor, strokeWidth: 1.0, gap: 3.0,),
                    ),
                    SizedBox(height: scale.getHeight(0.5)),
                    FunctionalWidget.betweenText(
                        context: context,
