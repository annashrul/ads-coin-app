...
class DetailHistoryPurchaseComponent extends StatefulWidget {
  ...
  @override
  _DetailHistoryPurchaseComponentState createState() =>
      _DetailHistoryPurchaseComponentState();
}

class _DetailHistoryPurchaseComponentState
    extends State<DetailHistoryPurchaseComponent> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FunctionalWidget.appBarHelper(
          context: context, title: "Detail pembelian"),
      body: history.isLoadingDetailHistoryPurchase
          ? LoadingDetailHistoryPurchaseOrSale()
          : ListView(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ImageRoundedWidget(
                            img: history
                                .detailHistoryPurchaseModel.result.imageProduct,
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                history.detailHistoryPurchaseModel.result.title,
                              ...
                              FunctionalWidget.spaceText(
                                  ...
                                  child: FunctionalWidget.rating(
                                      context: context,
                                      rate: double.parse(2.toString()))),
                              FunctionalWidget.spaceText(
                                  context: context,
                                  title: "Penulis",
                                  desc: history
                                      .detailHistoryPurchaseModel.result.seller)
                            ],
                          )
                        ],
                      )
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FunctionalWidget.betweenText(
                          context: context,
                          title: "Harga produk",
                          desc: FunctionalWidget.toCoin(double.parse(history
                              .detailHistoryPurchaseModel.result.grandTotal))),
                      FunctionalWidget.betweenText(
                          context: context,
                          title: "Biaya admin",
                          desc: FunctionalWidget.toCoin(double.parse(history
                              .detailHistoryPurchaseModel.result.biayaAdmin))),
