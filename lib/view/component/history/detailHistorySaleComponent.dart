...
class DetailHistorySaleComponent extends StatefulWidget {
  ...
  @override
  _DetailHistorySaleComponentState createState() =>
      _DetailHistorySaleComponentState();
}

class _DetailHistorySaleComponentState
    extends State<DetailHistorySaleComponent> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FunctionalWidget.appBarHelper(
          context: context, title: "Detail laporan penjualan"),
      body: history.isLoadingDetailHistorySale
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ImageRoundedWidget(
                            img: history
                                .detailHistorySaleModel.result.imageProduct,
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                history.detailHistorySaleModel.result.title,
                              ...
                              FunctionalWidget.spaceText(
                                  ...
                                  title: "Penulis",
                                  desc: history
                                      .detailHistorySaleModel.result.seller)
                            ],
                          )
                        ],
                      )
                    ...
                    children: [
                      ...
                      FunctionalWidget.betweenText(
                          ...
                          desc: FunctionalWidget.toCoin(double.parse(history
                              .detailHistorySaleModel.result.grandTotal))),
                      FunctionalWidget.betweenText(
                          context: context,
                          title: "Biaya admin",
                          desc: FunctionalWidget.toCoin(double.parse(history
                              .detailHistorySaleModel.result.biayaAdmin))),
