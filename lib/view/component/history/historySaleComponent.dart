  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FunctionalWidget.appBarHelper(
          context: context, title: "Laporan penjualan"),
      body: Column(
        children: [
          FunctionalWidget.filterDate(
              context: context,
              data: {
                "from": history.fromHistorySale,
                "to": history.toHistorySale
              },
              callback: (from, to) {
                history.setDateFromDateToHistorySale(
                    context: context, input: {"from": from, "to": to});
              }),
          Expanded(
            child: history.isLoadingHistorySale
                ? LoadingHistoryPurchase()
                : history.historySaleModel == null
                    ? NoDataWidget()
                    : ListView.separated(
      ...
      bottomNavigationBar: history.isLoadMoreHistorySale
          ? Container(
