          ...
          body: RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                    ...
                    callback: () {
                      if (promo.promoModel != null) {
                        Navigator.of(context)
                            .pushNamed(RouteString.detailPromo);
                      }
                    },
                    radius: 10,
                    child: Container(
                          ...
                          image: DecorationImage(
                              ...
                              image: NetworkImage(
                                !promo.isLoadingPromo ||
                                    ...
                                    ? GeneralString.dummyImgProduct
                                    : promo.promoModel.result.image,
                              ))),
                        ...
                        children: [
                          Expanded(
                              child: promo.isLoadingPromo
                                  ...
                                  : Text(
                                      promo.promoModel == null
                                          ? "Situs kami memberi jaminan jam kerja tepat waktu dan penulisan memuaskan"
                                          : promo.promoModel.result.deskripsi,
                ...
                Padding(
                  ...
                  child: TitleSectionWidget(
                      ...
                      callback: () => Navigator.of(context)
                          .pushReplacementNamed(RouteString.main,
                              arguments: TabIndexString.tabProduct)),
                ),
                Container(
                  padding: scale.getPadding(0.5, 2.5),
                  height: scale.getHeight(30),
                  child: product.isLoadingBestSeller
                      ? LoadingProductHorizontal()
                      : product.productBestSellerModel == null
                          ? NoDataWidget()
                          : ListView.builder(
                              ...
                              itemCount:
                                  product.productBestSellerModel.result.length,
                              itemBuilder: (BuildContext context, int index) {
                                if (favorite.data.length > 0) {
                                  for (int i = 0;
                                      i < favorite.data.length;
                                      i++) {
                                    if (favorite.data[i]
                                            [TableString.idProduct] ==
                                        product.productBestSellerModel
                                            .result[index].id) {
                                      product.productBestSellerModel
                                          .result[index].isFavorite = "1";
                                      break;
                                    }
                                    continue;
                                  }
                                ...
                                return ProductWidget1(
                                  ...
                                  heroTag: "produkTerlaris" +
                                      product.productBestSellerModel
                                          .result[index].id,
                                  isFavorite: product.productBestSellerModel
                                              .result[index].isFavorite ==
                                          "0"
                                      ? false
                                      : true,
                                  id: product
                                      .productBestSellerModel.result[index].id,
                                  title: product.productBestSellerModel
                                      .result[index].title,
                                  price: product.productBestSellerModel
                                      .result[index].price,
                                  productSale:
                                      "${product.productBestSellerModel.result[index].terjual} terjual",
                                  image: product.productBestSellerModel
                                      .result[index].image,
                                  isContributor: true,
                                  nameContributor: product
                                      .productBestSellerModel
                                      .result[index]
                                      .seller,
                                  imageContributor: product
                                      .productBestSellerModel
                                      .result[index]
                                      .sellerFoto,
                                  rateContributor: double.parse(product
                                      .productBestSellerModel
                                      .result[index]
                                      .rating
                                      .toString()),
                ...
                product.isLoadingNew
                    ? LoadingProduct()
                    : product.productNewModel == null
                        ? NoDataWidget()
                        : Container(
                            padding: scale.getPadding(0.5, 2.5),
                            child: new StaggeredGridView.countBuilder(
                              ...
                              itemBuilder: (context, index) {
                                if (favorite.data.length > 0) {
                                  for (int i = 0;
                                    ...
                                    if (favorite.data[i]
                                            [TableString.idProduct] ==
                                        product
                                            .productNewModel.result[index].id) {
                                      product.productNewModel.result[index]
                                          .isFavorite = "1";
                                      break;
                                    }
                                    continue;
                                ...
                                return ProductWidget1(
                                  ...
                                  heroTag: "produkTerbaru" +
                                      product.productNewModel.result[index].id,
                                  isFavorite: product.productNewModel
                                              .result[index].isFavorite ==
                                          "0"
                                      ? false
                                      : true,
                                  ...
                                  title: product
                                      .productNewModel.result[index].title,
                                  price: product
                                      .productNewModel.result[index].price,
                                  productSale:
                                      "${product.productNewModel.result[index].terjual} terjual",
                                  image: product
                                      .productNewModel.result[index].image,
                                  isContributor: true,
                                  nameContributor: product
                                      .productNewModel.result[index].seller,
                                  imageContributor: product
                                      .productNewModel.result[index].sellerFoto,
                                  rateContributor: double.parse(product
                                      .productNewModel.result[index].rating
                                      .toString()),
                                );
                              },
                            ),
                          ),
                if (!user.isLoadingLeaderBoard && user.leaderBoardModel != null)
                  Padding(
                    padding: scale.getPadding(0, 2.5),
                    child: TitleSectionWidget(
                      title: "Leaderboard",
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return FunctionalWidget.wrapContent(
                            ...
                            onTap: () => Navigator.of(context).pushNamed(
                                RouteString.profilePerMember,
                                arguments: val.id),
                            leading: CircleAvatar(
                                backgroundColor: Colors.transparent,
                                radius: 20,
                                backgroundImage: NetworkImage(val.foto)),
                            title: Text(val.fullname,
                                style: Theme.of(context).textTheme.headline2),
                            subtitle: Text(val.bio != null ? val.bio : "-",
                            ...
                            trailing: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: FunctionalWidget.rating(
                                      context: context,
                                      rate:
                                          double.parse(val.rating.toString())),
                                ),
                                Text(val.copyTerjual + " copy",
                                    style: Theme.of(context)
                                        .textTheme
                                        .subtitle1
                                        .copyWith(
                                            color:
                                                ColorConfig.bluePrimaryColor),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis),
                              ],
                            ),
