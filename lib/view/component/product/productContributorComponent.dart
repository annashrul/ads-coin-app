    ...
    return WillPopScope(
        child: Scaffold(
          appBar: FunctionalWidget.appBarWithFilterHelper(
              context: context,
              title: "Daftar produk",
              callback: ()=>Navigator.of(context).pushNamedAndRemoveUntil(RouteString.main, (route) => false,arguments: TabIndexString.tabProfile),
              action: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    InTouchWidget(
                        ...
                        child: Row(
                          children: [
                            Image.asset(GeneralString.imgLocalPng+"PaperPlus.png",height: scale.getHeight(1),color:ColorConfig.bluePrimaryColor,),
                            SizedBox(width: scale.getWidth(1)),
                            Text("Tambah produk",style: Theme.of(context).textTheme.headline2.copyWith(color:ColorConfig.bluePrimaryColor))
                          ],
                        )
                    ),
                    Text("Total : ${!product.isLoadingProductContributor&&product.productContributorModel!=null?"${product.productContributorModel.meta.total}":"0"} produk",style: Theme.of(context).textTheme.headline2)
