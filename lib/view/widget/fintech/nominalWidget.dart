      ...
      itemBuilder: (BuildContext context, int index) {
        return FunctionalWidget.wrapContent(
          child: FlatButton(
            ...
            child: Text("${MoneyFormat.toCurrency(double.parse(MoneyFormat.dataNominal[index]))} coin",style: Theme.of(context).textTheme.subtitle1.copyWith(color: widget.idx==index?Colors.white:ColorConfig.grayPrimaryColor),),
          )
        );
      },
